...
<head>
    ...
    <title>The Ribbon | Learn Excel</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">The Ribbon</a>
            </div>
            ...
            <div class="row clearfix">
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <p>The Excel ribbon refers to the tabs at the top of the Excel interface that helps users to navigate and locate the commands when using Excel.</p> 
                            <img src="../images/theribbon.gif" height="90px width=15px">
                        </div>
                    </div>
                </div>
            </div>
